...
|---|---|---|---|
| `tennis_serve` | 53 | 54.7% | 38 格 |
| `bowling` | 57 | 45.6% | 21 格 |
| **`baseball_swing`** | **74** | **44.6%** | 14 格 |
| `baseball_pitch` | 25 | 44.0% | 19 格 |
| `tennis_forehand` | 61 | 41.0% | 24 格 |
| **`golf_swing`** | 452 | **17.5%** | **9 格** |
| 隨機基準 | | 16.7% | |

**五個運動都遠高於隨機，只有高爾夫在隨機水準。** 差別不在運動種類，在動作有多快——
窗長與成立率的相關係數 `r = +0.78`。高爾夫下桿只有 9 格（300 ms），三個環節的峰值本來
就擠在一起。
